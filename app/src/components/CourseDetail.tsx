        ...
        if (finalizedFlight) {
          await logCourseDelta({
            ...
            payload: {
              ...
              landingPendingUntil: finalizedFlight.landingPendingUntil ?? null,
    ...
    if (id && flight.syncId) {
      ...
      await logCourseDelta({
        ...
        payload: {
          ...
          landingMarkedAt: flight.landingMarkedAt ?? null,
          landingPendingUntil: flight.landingPendingUntil ?? null,
          landingFinalizedAt: flight.landingFinalizedAt ?? null,
